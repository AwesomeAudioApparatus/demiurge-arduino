...
double Cordic::angle_shift ( double alpha, double beta )
...
double Cordic::arccos_cordic ( double t, int n )
...
void Cordic::arccos_values ( int &n_data, double &x, double &fx )
...
double Cordic::arcsin_cordic ( double t, int n )
...
void Cordic::arcsin_values ( int &n_data, double &x, double &fx )
...
double Cordic::arctan_cordic ( double x, double y, int n )
...
void Cordic::arctan_values ( int &n_data, double &x, double &fx )
...
double Cordic::cbrt_cordic ( double x, int n )
...
void Cordic::cbrt_values ( int &n_data, double &x, double &fx )
...
void Cordic::cos_values ( int &n_data, double &x, double &fx )
...
void Cordic::cossin_cordic ( double beta, int n, double &c, double &s )
...
double Cordic::exp_cordic ( double x, int n )
...
void Cordic::exp_values ( int &n_data, double &x, double &fx )
...
int Cordic::i4_min ( int i1, int i2 )
...
double Cordic::ln_cordic ( double x, int n )
...
void Cordic::ln_values ( int &n_data, double &x, double &fx )
...
double Cordic::multiply_cordic ( double x, double y )
...
double Cordic::r8_uniform_01 ( int &seed )
...
void Cordic::sin_values ( int &n_data, double &x, double &fx )
...
double Cordic::sqrt_cordic ( double x, int n )
...
void Cordic::sqrt_values ( int &n_data, double &x, double &fx )
...
double Cordic::tan_cordic ( double beta, int n )
...
void Cordic::tan_values ( int &n_data, double &x, double &fx )
