...
void loop() {
  ...
  double hist0 = ((oscillator_t *) vco1._signal.data)->hist[0];
  double hist1 = ((oscillator_t *) vco1._signal.data)->hist[1];
  double hist2 = ((oscillator_t *) vco1._signal.data)->hist[2];
  double hist3 = ((oscillator_t *) vco1._signal.data)->hist[3];
  double hist4 = ((oscillator_t *) vco1._signal.data)->hist[4];
  double hist5 = ((oscillator_t *) vco1._signal.data)->hist[5];
  double hist6 = ((oscillator_t *) vco1._signal.data)->hist[6];
...
//  double value3 = ((audio_out_port_t *) out1._signal.data)->cached;
  ...
  Serial.print( ", " );
  Serial.print(demiurge._dac->descs->buf[4]);
  Serial.print( ", " );
  Serial.print(demiurge._dac->descs->buf[5]);
